        ...
        <div className="px-6 py-8 md:px-12 md:py-12">
          ...
          <article className="max-w-5xl mx-auto">
            ...
            <div className="text-white text-base md:text-lg leading-relaxed space-y-6">
              ...
              <p>
                In early 2021 Takeoff Monkey caught the attention of a small industry-run fund owned by members of the leadership team at Ruppert Landscape, one of the largest and most reputable landscape contractors in the U.S. This partnership provided not only capital but also deep industry insight, industry credibility, and allowed for expansion across operations, technology, and market reach.
              </p>
              ...
              <p>
                The idea for Takeo began to take shape in early 2025, and by mid-year was a clear and obvious vision. Through the help of Marc, Janine, and Kerosene Ventures, here we are! Poised and ready to revolutionize the construction industry for subcontractors, putting powerful, accessible technology into the hands of the hundreds of thousands of contractors who build our country. Together, we'll level the playing field, giving subcontractors the same (or more) technological horsepower as their general contractor clients, adding endless efficiency to pre-construction departments across North America, and improving the quality of life in an otherwise chaotic, fragmented industry. Thank you for reading!
              </p>
            </div>
          </article>
