...
const apps = [
  ...
  {
    name: "Note & Instruction Updater",
    href: "https://example.com/upload-portal",
    description: "Instantly update notes & instructions across multiple interfaces by simply sending a Slack message",
    tag: "Slack Bot",
    status: "Live",
  },
  {
    ...
    description: "Generate revision requests of completed projects with new documents & instructions.",
    tag: "Slack Bot",
    status: "Live",
  },
  {
    ...
    description: "Slack bot with access to every project you've ever completed, and all the associated data. Ask it anything about your work!",
    tag: "Slack Bot",
    status: "Live",
  },
];
